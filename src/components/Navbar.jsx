...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu bg-teal-900 menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52">
        {navLink}
      </ul>
    </div>
    <a className="btn btn-ghost normal-case text-xl hidden lg:block">Language Dictation Learning</a>
  </div>
